...
## Игра "Светлячки"
Идентификатор игры - **GameIdentifiers['lights']**
### Параметры игры
| Название | Тип значения | Значение по умолчанию | Описание |
| :---:   | :---: | :---: | :---: |
| elementsTotal | number | 2 | Кол-во светлячков |
| timeComplete | number | 10 | Время(секунды) на слежение за светлячками, после появления дополнительных |
### Результат игры
| Название | Тип значения | Значение | Описание |
| :---:   | :---: | :---: | :---: |
| result | string | 'end'\|'lose' | end - конец игры |
...
## Игра "Аргус"
Идентификатор игры - **GameIdentifiers['argus']**
### Параметры игры
| Название | Тип значения | Значение по умолчанию | Описание |
| :---:   | :---: | :---: | :---: |
| elementsTotal | number | 2 | Кол-во правильных ответов |
| errorAacceptable | number | 2 | Кол-во возможных ошибок ответов |
| timeComplete | number | 10 | Время(секунды) на прохождение игры |
| speed | number | 2000 | Время(милисекунды) на запоминание цифр |
### Результат игры
| Название | Тип значения | Значение | Описание |
| :---:   | :---: | :---: | :---: |
| result | string | 'end'\|'lose' | end - конец игры |
| success | number | Число | Количество правильных ответов |
| failed | number | Число | Количество допущенных ошибок |
