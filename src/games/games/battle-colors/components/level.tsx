...
export default class extends Component<any, any> {
  ...
  onSubmit =
    (result = 'error') =>
    () => {
      const { colorLeft, colorRight } = this.state;
      ...
      if (result == 'success' && colorLeft.color === colorRight.color) {
        onSuccess();
      } else if (result == 'error' && colorLeft.color !== colorRight.color) {
        onSuccess();
      } else {
        onError();
      }
    ...
    return (
      <View style={styles.wrap}>
        <Text style={styles.title}>
          Совпадает ли название цвета в левом блоке с цветом слова в правом?
        </Text>
        <View style={styles.inner}>
          <View style={styles.item}>
            ...
            >
              <Text style={styles.colorTitle}>{colorLeft.title}</Text>
            </View>
          </View>
          <View style={styles.item}>
            <View
